 ...
 */
    ...
    var mainHtmls = {};
    var blankRegs = [];
    var target='http://www.tzga.gov.cn:6080';
    var cacheRegex = /(\/image\/|\/images\/|\.css$|\.js$)/i
    var ignoreRegex
    blankRegs.push(/<script[^>]*>[^<>]+baidu\.com[^<>]+<\/script>/gmi);
    var injs = autoProxy.getInjectedHtml()
        + ' <script type="text/javascript" src="/zj/injected-10576.js"></script>';

    var mainHtmlArray=[];
    var url = '/wscgs/vio.do?act=veh_vio_page';
    var mainHtml = {url: url,
        origin: saveFileName.origin( 'origin_10576_vio_query.html'),
        overload: saveFileName.overload('overload_10576_vio_query.html'),
    ...
    mainHtml =  {url: url, origin: saveFileName.origin( 'origin_10576_vio_save.html'),
