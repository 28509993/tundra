 ...
 */
    ...
    var mainHtmls = {};
    var blankRegs = [];
    var target='http://www.shjtaq.com';
    var cacheRegex = /(\/image\/|\/images\/|\.css$|\.js$)/i
    var ignoreRegex
    blankRegs.push(/<script[^>]*>[^<>]+baidu\.com[^<>]+<\/script>/gmi);
    var injs = autoProxy.getInjectedHtml()
        + ' <script type="text/javascript" src="/zj/injected-10021.js"></script>';

    var mainHtmlArray=[];
    var url = '/zwfg/chafen.asp';
    var mainHtml = {url: url,
        origin: saveFileName.origin( 'origin_10021_vio_query.html'),
        overload: saveFileName.overload('overload_10021_vio_query.html'),
    ...
    mainHtml =  {url: url, origin: saveFileName.origin( 'origin_10021_vio_save.html'),
    ...
    proxyOptions = {target:target,mainHtmls: mainHtmls, blankRegs: blankRegs
        , cacheRegex: cacheRegex, ignoreRegex: ignoreRegex,charset:'utf-8'}
}();
