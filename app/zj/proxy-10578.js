 ...
 */
    ...
    var mainHtmls = {};
    var blankRegs = [];
    var target='http://jj.lishui.gov.cn';
    var cacheRegex = /(\/image\/|\/images\/|\.css$|\.js$)/i
    var ignoreRegex
    blankRegs.push(/<script[^>]*>[^<>]+baidu\.com[^<>]+<\/script>/gmi);
    var injs = autoProxy.getInjectedHtml()
        + ' <script type="text/javascript" src="/zj/injected-10578.js"></script>';

    var mainHtmlArray=[];
    var url = '/queryInfo.do?act=vehVio';
    var mainHtml = {url: url,
        origin: saveFileName.origin( 'origin_10578_vio_query.html'),
        overload: saveFileName.overload('overload_10578_vio_query.html'),
    ...
    mainHtml =  {url: url, origin: saveFileName.origin( 'origin_10578_vio_save.html'),
