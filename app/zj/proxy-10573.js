 ...
 */
    ...
    var mainHtmls = {};
    var blankRegs = [];
    var target='http://60.190.151.158:8080';
    var cacheRegex = /(\/image\/|\/images\/|\.css$|\.js$)/i
    var ignoreRegex
    blankRegs.push(/<script[^>]*>[^<>]+baidu\.com[^<>]+<\/script>/gmi);
    var injs = autoProxy.getInjectedHtml()
        + ' <script type="text/javascript" src="/zj/injected-10573.js"></script>';

    var mainHtmlArray=[];
    var url = '/queryVehVio.do';
    var mainHtml = {url: url,
        origin: saveFileName.origin( 'origin_10573_vio_query.html'),
        overload: saveFileName.overload('overload_10573_vio_query.html'),
    ...
    mainHtml =  {url: url, origin: saveFileName.origin( 'origin_10573_vio_save.html'),
